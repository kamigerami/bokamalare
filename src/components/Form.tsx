...
function Typ() {
  return (
    <div>
      ...
      <button className="mt-1 ml-2 rounded-md border border-transparent bg-blue-600 py-2 px-3 text-base font-medium text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:text-sm">
        Nästa steg 
      </button>
      </div>
  );
